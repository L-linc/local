...
import Vue from 'vue';
import DeviceAlarm from '@/views/assetsManage/DeviceAlarm.vue';
import DeviceAttr from '@/views/assetsManage/DeviceAttr.vue';
import DeviceCycle from '@/views/assetsManage/DeviceCycle.vue';
import DeviceData from '@/views/assetsManage/DeviceData.vue';
